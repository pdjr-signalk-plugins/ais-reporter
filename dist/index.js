        ...
        return (setInterval(() => {
            ...
            pluginConfiguration.endpoints.forEach((endpoint) => {
                try {
                    ...
                    var totalBytes = 0;
                    let mvIDX = ((endpoint.myVessel.overrideTriggerPath) ? (app.getSelfPath(endpoint.myVessel.overrideTriggerPath) || 0) : 0);
                    let ovIDX = ((endpoint.otherVessels.overrideTriggerPath) ? (app.getSelfPath(endpoint.otherVessels.overrideTriggerPath) || 0) : 0);
